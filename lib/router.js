...
//423Down apk软件
router.get('/fjnews/423down', require('./routes/fjnews/423down'));
router.get('/fjnews/qqjd', require('./routes/fjnews/qqjd'));

//电力网 发电,如基层动态的type为jcdt, http://www.chinapower.com.cn/fd/jcdt/
router.get('/fjnews/dlw/:type', require('./routes/fjnews/dlw'));

//能源集团公司 zh=综合新闻 yw=要闻
router.get('/fjnews/ceic/:type', require('./routes/fjnews/ceic'));

//电力招聘
router.get('/fjnews/zp_gdjt', require('./routes/fjnews/zp_gdjt'));
router.get('/fjnews/zp_dtfd', require('./routes/fjnews/zp_dtfd'));

// 九江新闻jjnews 增加limit=25为江西新闻
router.get('/fjnews/jjnews22/:limit', require('./routes/fjnews/jjnews22'));


//2023-12-29新增
//新华网江西频道
router.get('/fjnews/zxwjxnews', require('./routes/fjnews/zxwjxnews'));
//九江九广网
//router.get('/fjnews/jjnews', require('./routes/fjnews/jjnews'));
// 江西25; 九江新闻其他
router.get('/fjnews/jjnews/:limit', require('./routes/fjnews/jjnews'));

// 福建新闻fj,福州fz;增加limit=25为海峡网备用
router.get('/fjnews/fznews/:city/:limit', require('./routes/fjnews/fznews'));
