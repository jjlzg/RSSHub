...
let host = 'http://www.cdtrczp.com/cdtrw/NewsCenter.aspx';
...
module.exports = async (ctx) => {
	...
	const link = $('tr').attr('onclick').replace("window.open('","").replace("')","");
	//console.log(link[i]);
        ...
        const contents = capture('div.page_content_wap').html();
